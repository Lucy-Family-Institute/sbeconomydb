...
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/data/raw/South Bend MSA/Jobs/update once a month/Advertised Job Skills/")
...
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/data/raw/Elkhart Goshen MSA/Jobs/update once a month/Advertised Job Skills/")
...
bind_rows(skills_jobs_sb,skills_jobs_eg)%>%
  write_rds("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/data/skills_jobs.Rds")

rm(skills_jobs_sb,skills_jobs_eg)

#### Tools and Technologies in demand ####
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/data/raw/South Bend MSA/Jobs/update once a month/Advertised Tools and Technology/")
...
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/data/raw/Elkhart Goshen MSA/Jobs/update once a month/Advertised Tools and Technology/")
...
bind_rows(tools_jobs_sb,tools_jobs_eg)%>%
  write_rds("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/data/tools_jobs.Rds")

rm(tools_jobs_sb,tools_jobs_eg)

#### Job Certifications ####
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/data/raw/South Bend MSA/Education, Training and Experience/update once a month/Advertised Job Certifications/")
...
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/data/raw/Elkhart Goshen MSA/Education, Training and Experience/update once a month/Advertised Job Certifications/")
...
bind_rows(certifications_jobs_sb,certifications_jobs_eg)%>%
  write_rds("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/data/certifications_jobs.Rds")

rm(certifications_jobs_sb,certifications_jobs_eg)

#### monthly change in unemployed and jobs ####
library(rvest)

setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/data/raw/South Bend MSA/Demand and Supply/update once a month/Number of Unemployed per Job Opening")
...
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/data/raw/Elkhart Goshen MSA/Demand and Supply/update once a month/Number of Unemployed per Job Opening")
...
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/data/raw/other MSAs/Number of Unemployed per Job Opening Distribution/")
...
emp %>%
  ...
  write_rds("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/data/emp_change.Rds")
...
selected_series_sb_elk_msa <- read_csv("data/raw/selected_ces_series_sb_elk_msa.csv")
...
sb_elk_ces_supersectors$dt %>% max() # "2022-03-01" # latest date
...
write_rds(sb_elk_ces_sup,"data/sb_elk_ces_sup.Rds")
...
write_rds(laus_select,"data/laus_select.Rds")
...
yr_mnth <- sprintf('%s%s', eg[,1], eg[,2]) %>% sort() %>% head(x,n=-9) # lost last 11 months of 2022 for which data is not available
...
write_rds(housing_sb,"data/housing_sb.Rds")
...
sb_weekly %>% write_rds("data/sb_weekly_evictions.Rds")
rm(sb_evictions,sb_weekly)

# home values
home_prices <- read_csv("data/raw/Metro_zhvi_uc_sfrcondo_tier_0.33_0.67_sm_sa_month.csv")
...
home_prices_in %>% write_rds("data/home_prices_in.Rds")
rm(home_prices,home_prices_in)

### poverty and spending ###
snap_tanf_df <- lapply(list.files("data/raw/poverty/snap and tanf/",pattern = ".xls"), function (x) {
  print(x)
...
snap_tanf_df %>% write_rds("data/snap_tanf_df.Rds")
rm(snap_tanf_df)

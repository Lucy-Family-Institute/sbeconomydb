...
# Data manipulation
#### Jobs ####
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/raw data/South Bend MSA/Jobs/Jobs Available")
...
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/raw data/Elkhart Goshen MSA/Jobs/Jobs Available")
...
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/raw data/South Bend MSA/Jobs/Industries by Advertised Jobs")
...
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/raw data/Elkhart Goshen MSA/Jobs/Industries by Advertised Jobs")
...
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/raw data/South Bend MSA/Education, Training and Experience/Education Level of Jobs and Candidates")
...
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/raw data/Elkhart Goshen MSA/Education, Training and Experience/Education Level of Jobs and Candidates")
...
write_rds(df,"G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/app/data/df.Rds")

rm(df,df0,df1,df_educ)

#### Candidate level data ####
#### Total Candidates ####
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/raw data/South Bend MSA/Candidates/Candidates Available")
...
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/raw data/Elkhart Goshen MSA/Candidates/Candidates Available")
...
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/raw data/South Bend MSA/Candidates/Candidates By Occupation Group")
...
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/raw data/Elkhart Goshen MSA/Candidates/Candidates By Occupation Group")
...
write_rds(df_cand,"G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/app/data/df_cand.Rds")
...
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/raw data/South Bend MSA/Jobs/Employers by Number of Job Openings")
...
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/raw data/Elkhart Goshen MSA/Jobs/Employers by Number of Job Openings")
...
bind_rows(employers_jobs_sb,employers_jobs_eg)%>%
  write_rds("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/app/data/employers_jobs.Rds")

rm(employers_jobs_sb,employers_jobs_eg)

#### occupations ####
# South bend
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/raw data/South Bend MSA/Jobs/Occupations by Advertised Jobs")

latest_date <- list.files(pattern = ".xls") %>% mdy() %>% max()
...
setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/raw data/Elkhart Goshen MSA/Jobs/Occupations by Advertised Jobs")
...
bind_rows(jobs_occupations_sb,jobs_occupations_eg)%>%
  write_rds("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/app/data/jobs_occupations.Rds")
rm(jobs_occupations_sb,jobs_occupations_eg)

setwd("G:/Shared drives/Lucy Family Institute Team drive/Dashboards/sbeconomydb/") # get back to root directory

...
sb_elk_ces_supersectors$dt %>% max() # "2022-11-01" # latest date
...
sb_elk_ces_sup$dt %>% max() # "2022-11-01"
...
sb_elk_ces_supersectors_wage$dt %>% max() # "2022-11-01" # latest date
...
laus_select_areas$dt %>% max() # "2022-10-01"
...
sb_evictions$week_date %>% max() # "2022-12-04"
...
home_prices_in$dt %>% max() # "2022-11-31"
...
fhfa_hpi_in$yr_q %>% max() # "2022-07-01 should be second quarter
